...
# True: ko phan san
# load csv
non_san_df = pd.read_csv('data/07_11_san_data.csv')
...
non_san_df.to_csv('data/07_11_san_dat_fixed.csv', index=False)


# False: ko phan san
# load csv
non_san_df = pd.read_csv('data/07_11_non_san_data.csv')
...
# save the modified df back to csv
non_san_df.to_csv('data/07_11_non_san_dat_fixed.csv', index=False)
